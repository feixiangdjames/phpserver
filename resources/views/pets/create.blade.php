        ...
        <form action="{{route('pets.store')}}" method="POST" accept-charset="UTF-8" enctype="multipart/form-data">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    ...
                    <small class="form-text text-muted">Any title for the pet.</small>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    ...
                    <small class="form-text text-muted">rate for the pet.</small>
                </div>
            </div>
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    ...
                    <small class="form-text text-muted">price for the pet.</small>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-5">
                    ...
                    <small class="form-text text-muted">description for the item.</small>
                </div>
            </div>
            @csrf
            <div class="form-group row">
